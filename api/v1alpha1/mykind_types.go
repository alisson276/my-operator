...
type MyKindStatus struct {
	...
	// conditions represent the current state of the MyKind resource.
...
type MyKind struct {
	...
	// spec defines the desired state of MyKind
	// +required
	Spec MyKindSpec `json:"spec"`

	// status defines the observed state of MyKind
	// +optional
	Status MyKindStatus `json:"status,omitempty,omitzero"`
}
