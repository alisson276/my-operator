...
// +kubebuilder:rbac:groups=mygroup.operator.com,resources=mykinds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mygroup.operator.com,resources=mykinds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=mygroup.operator.com,resources=mykinds/finalizers,verbs=update
